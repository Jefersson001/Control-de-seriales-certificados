        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-4xl text-left">
                <thead class="bg-slate-50 text-xs uppercase tracking-wider text-slate-500 dark:bg-slate-950/40">
                    <tr><th class="px-6 py-4">Despacho Odoo</th><th class="px-6 py-4">Fecha</th><th class="px-6 py-4">Creado por</th><th class="px-6 py-4">NIV</th><th class="px-6 py-4">Estado</th></tr>
                </thead>
                <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                    ...
                    @empty
                        <tr><td colspan="5" class="px-6 py-14 text-center"><p class="font-semibold">No se encontraron despachos</p><p class="mt-1 text-sm text-slate-500">Crea el primer despacho o cambia la búsqueda.</p></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
